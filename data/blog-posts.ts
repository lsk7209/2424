...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: '월세 계약해지 통보 문자 예시와 전세 만기 발송 시점',
    excerpt: '월세·전세 계약을 끝낼 때 보낼 문자 예시와 발송 시점을 정리했습니다. 만기 전 통보 문구, 증거 남기는 방법, 주의할 표현을 확인하세요.',
    date: '2026-04-23',
    category: '전세안전',
    keywords: ['월세 계약해지 통보 문자 예시', '전세 만기 통보', '월세 만기 문자', '계약 종료 통보', '보증금 반환 준비'],
    faq: [
      {
