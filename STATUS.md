...
## 최근 변경 (최근 5개만)
- 04-23: 블로그·가이드·문의 페이지 깨짐 복원 및 내부 링크 정리
- 04-23: 광고 및 제휴 안내 페이지 추가, 푸터와 사이트맵 연결
- 04-23: manifest와 아이콘 추가로 PWA/메타 404 제거
- 04-23: 신규 콘텐츠 5건 추가로 고유 정보성 콘텐츠 확장
...
- 콘텐츠: 현재 블로그 10개, 가이드 16개 공개 상태
## 주의
- `baseline-browser-mapping` 업데이트 권고는 남아 있으나 lint/build 실패 원인은 아님
- GSC 자동 개선 스크립트는 `today2424.kr` 기준 이슈 0건으로 종료됨
