...
export async function generateMetadata(props: BlogPostPageProps) {
  ...
  const title = createSeoTitle(post.title);
    ...
    <div className="min-h-screen flex flex-col bg-white font-pretendard">
      ...
      <main className="flex-1 container max-w-4xl mx-auto py-12 px-4 md:px-6">
        <article className="mx-auto">
          ...
          <aside className="mb-10 rounded-xl border border-blue-200 bg-blue-50 p-6">
            <p className="text-sm font-bold text-blue-700">콘텐츠 검토 기준</p>
          ...
          <aside className="mt-14 rounded-xl border border-slate-200 bg-slate-50 p-6">
            <p className="text-sm font-bold text-blue-700">공식 자료 함께 확인</p>
            ...
            <a
              ...
              className="mt-4 inline-flex font-bold text-blue-600 hover:underline"
            >
              공식 사이트에서 확인하기
            </a>
          </aside>
