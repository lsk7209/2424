...
export const metadata = createPageMetadata({
  title: '문의하기',
  description: '이사독립 서비스 문의, 제휴 제안, 기능 개선 요청을 보낼 수 있는 페이지입니다.',
  path: '/contact',
  keywords: ['문의하기', '제휴 문의', '서비스 제안'],
});
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '이사독립은 사용자의 개인정보를 서버에 저장하지 않습니다. 모든 데이터는 사용자의 브라우저에만 저장됩니다.',
        },
      },
      {
        '@type': 'Question',
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>자주 문의하시는 내용을 정리했습니다</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  전세 사기 진단은 참고용 정보이며, 법적 효력은 없습니다. 실제 계약 전에는 반드시 법무사나 전문가와 상담하시기 바랍니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  이사독립은 사용자의 개인정보를 서버에 저장하지 않습니다. 모든 데이터는 사용자의 브라우저에만 저장됩니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  언제든 환영합니다. 이메일이나 카카오톡으로 제안해 주시면 검토 후 서비스에 반영하도록 노력하겠습니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-muted/50">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <p className="text-muted-foreground pt-2">
                문의 주신 내용은 영업일 기준 1~2일 내에 확인합니다.
              </p>
            </CardContent>
          </Card>
        </div>
